...
var dog_img, happyDog_img, milkImg;
var feed, addfood;
var fedTime, lastFed;
var foodObj;
...
function draw(){
  ...
  textSize(15);
  if(lastFed>=12){
    text("Last Feed : "+ lastFed%12 + " PM",350, 375);
  }
  else if(lastFed===0){
    text("Last Feed : 12 AM",350, 375);
  }
  else{
    text("Last Feed : "+ lastFed + " AM",350, 375);
  }
  ...
  if (dogState === "Happy"){
    var milk = createSprite(720, 220, 70, 70);
